        ...
        <div id="content">
            ...
            <div class="wrapper">
                <div id='bottomContent'>
                    <div class="comment">
                        <div class="arrows">
                            <div class="arrow-up" onmouseenter="brightenUp(this)" onmouseleave="darkenUp(this)"></div>
                            <div>456</div>
                            <div class="arrow-down" onmouseenter="brightenDown(this)" onmouseleave="darkenDown(this)"></div>
                        </div>
