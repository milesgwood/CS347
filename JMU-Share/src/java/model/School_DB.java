...
/**
 * This class handles all of the database interaction for the school
 * class
 * 
 * @author recinocs
 * @version 2016-12-1
...
public class School_DB {
    ...
    /**
     * This method adds a school if it isn't already present in the database.
     * A school is present if the schoolName is already present in the database
    ...
    /**
     * This method returns a school with the entered schoolname, or null if
     * no school is found
     * @param schoolName, the schoolName for the school being searched
     * @return the School found with the given schoolName, or null if no school exists
     * @throws SQLException 
     */
